...
plotNyquist_calcRohm(data5, 1, label5, 4000)
plotNyquist_calcRohm(data4, 1, label4, 6000)
#plotNyquist_calcRohm(data3, 1, label3, 8000)
...
axD.set_title('Nyquist Plot for Zn/0.5M Zn-TSFI GPE/Zn Symmetric Cell Experiments', fontweight='bold', y=-0.35)
