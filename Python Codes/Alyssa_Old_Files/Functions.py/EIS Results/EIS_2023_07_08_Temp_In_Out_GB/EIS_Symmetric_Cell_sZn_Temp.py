...
file = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_RT_C04.mpt'
data = readMPTData(file)
labels = 'Sanded Room Temperature'
...
file2 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_40C_C04.mpt'
...
file3 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_t2_C04.mpt'
data3 = readMPTData(file3)
label3 = 'Sanded 60C'

file4 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_overnight_C04.mpt'
data4 = readMPTData(file4)
label4 = 'Sanded 60C Overnight'

file5 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_C04.mpt'
data5 = readMPTData(file4)
label5 = 'Sanded 60C t1'
...
axD.set_title('Nyquist Plot for sZn/0.5M Zn-TSFI GPE/sZn Symmetric Cell Experiments', fontweight='bold', y=-0.35)
