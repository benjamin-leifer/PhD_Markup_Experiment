...
file = '0708_01_EIS_0.5MTFSI_Blocking_OutsideGB_24hr_60C_t2_C03.mpt'
data = readMPTData(file)
labels = '0708_01_EIS_0.5MTFSI_Blocking_InsideGB_day_2_40C_C01.mpt'
...
file5 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_60C_C04_C05.mpt'
data5 = readMPTData(file4)
label5 = 'Unsanded 60C t1'
...
axD.set_title('Nyquist Plot for Zn/0.5M Zn-TSFI GPE/Zn Symmetric Cell Experiments', fontweight='bold')
