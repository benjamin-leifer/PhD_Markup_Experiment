...
file = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_RT_C04_C05.mpt'
data = readMPTData(file)
labels = 'Unsanded Room Temperature'
...
file2 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_40C_C04_C05.mpt'
...
file3 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_60C_C04_t2_C05.mpt'
data3 = readMPTData(file3)
label3 = 'Unsanded 60C t2'

file4 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_60C_C04_overnight_C05.mpt'
data4 = readMPTData(file4)
label4 = 'Unsanded 60C Overnight'

file3 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_unsanded_60C_C04_C05.mpt'
data3 = readMPTData(file4)
label3 = 'Unsanded 60C'

file6 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_RT_C04.mpt'
data6 = readMPTData(file6)
labels6 = 'Sanded Room Temperature'

#file2 = 'C:\Users\benja\OneDrive - Northeastern University\Northeastern\Gallaway Group\PhD Markup Experiment\Python Codes\Alyssa_Old_Files\Functions.py\EIS Results\LL GPE\2023\0523\FullCell_EMD_ZnAnode_Calendar_30C_EIS_RT_C01.mpt'  # 'MIT cell B6_01_PEIS_C03.mpt' #B6 filename
file7 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_40C_C04.mpt'
data7 = readMPTData(file7)
label7 = 'Sanded 40C'

#file3 = 'C:\Users\benja\OneDrive - Northeastern University\Northeastern\Gallaway Group\PhD Markup Experiment\Python Codes\Alyssa_Old_Files\Functions.py\EIS Results\LL GPE\2023\0523\FullCell_EMD_ZnAnode_Calendar_60C_EIS_RT_C01.mpt'  # 'MIT cell B3_01_PEIS_C04.mpt' #B3 filename
file8 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_t2_C04.mpt'
data8 = readMPTData(file8)
label8 = 'Sanded 60C'

file9 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_overnight_C04.mpt'
data9 = readMPTData(file9)
label9 = 'Sanded 60C Overnight'

file10 = '0708_01_EIS_0.5MTFSI_SymCell_OutsideGB_sanded_60C_C04.mpt'
data10 = readMPTData(file10)
label10 = 'Sanded 60C t1'
...
#plotNyquist_calcRohm(data5, 1, label5, 8000)
#plotNyquist_calcRohm(data6, 1, labels6, 0)
#plotNyquist_calcRohm(data7, 1, label7, 2000)
#plotNyquist_calcRohm(data8, 1, label8, 4000)
plotNyquist_calcRohm(data9, 1, label9, 6000)
#plotNyquist_calcRohm(data10, 1, label10, 8000)
...
axD.set_title('Nyquist Plot for Zn/0.5M Zn-TSFI GPE/Zn Symmetric Cell Experiments (Sanded and Unsanded)', fontweight='bold', y=-0.35)

#axD.legend(loc='outside lower center')
axD.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc='lower left',
                      ncols=2, mode="expand", borderaxespad=0.)  #upper right
