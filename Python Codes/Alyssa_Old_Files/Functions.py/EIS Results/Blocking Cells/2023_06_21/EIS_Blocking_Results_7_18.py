...
plt.yscale('log')
ax1.plot(inv_Temp_array, in_GB, 'o', label='In Glovebox', color='red')
ax1.plot(inv_Temp_array, out_GB, 'o', label='Out of Glovebox', color='blue')
ax1.plot(inv_Temp_array, out_GB_24, '*', label='Out of Glovebox 24 Hours', color='blue')
