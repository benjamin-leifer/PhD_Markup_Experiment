...
new_dir_path = r'C:\Users\benja\OneDrive - Northeastern University\Gallaway Group\Gallaway Extreme SSD Drive\Equipment Data\Lab Arbin\Li-Ion\Low Temp Li Ion\08\DT14L,DTF14L,DTF14Gr Temp'
...
legends_minus_21C = {
    ...
    #'BL-LL-AZ04_-21C_t1_Channel_37_Wb_1.xlsx': 'Li||NMC - DT14 - -21C',
    #'BL-LL-AZ04_-32_t1_Channel_37_Wb_1.xlsx': 'Li||NMC - DT14 - -32C',
    'BL-LL-AZ04_-51C_t1_Channel_37_Wb_1.xlsx': 'Li||NMC - DT14 - -51C',
    #'BL-LL-BA02_RT_t1_Channel_47_Wb_1.xlsx': 'Li||NMC - DTF14 - RT',
    #'BL-LL-BA02_-21C_t1_Channel_38_Wb_1.xlsx': 'Li||NMC - DTF14 - -21C',
    #'BL-LL-BA02_-32_t1_Channel_38_Wb_1.xlsx': 'Li||NMC - DTF14 - -32C',
    'BL-LL-BA02_-51C_t2_Channel_38_Wb_1.xlsx': 'Li||NMC - DTF14 - -51C',
    #'BL-LL-BB04_RT_t1_Channel_55_Wb_1.xlsx': 'Gr||NMC - DTF14 - RT',
    #'BL-LL-BB04_-21C_t1_Channel_39_Wb_1.xlsx': 'Gr||NMC - DTF14 - -21C',
    #'BL-LL-BB04_-3C_t1_Channel_39_Wb_1.xlsx': 'Gr||NMC - DTF14 - -32C',
    'BL-LL-BB04_-51C_t2_Channel_39_Wb_1.xlsx': 'Gr||NMC - DTF14 - -51C',
}
#: 'Li||NMC - DTF14 - 51C'
